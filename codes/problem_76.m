...
function hessian_approx = findiff_hess_76(x, h)
...
for dim = 1:length(dimension)
    ...
    gradf_struct_MN(dim,1) = gradfk_norm;
    roc_struct_MN(dim,1) = compute_roc(xseq);
    disp(['**** MODIFIED NEWTON METHOD WITH FIN DIFF FOR THE PB 76 (point ', num2str(1), ', dimension ', num2str(n), '):  *****']);
    ...
    for i = 1:10
        ...
        disp(['**** MODIFIED NEWTON METHOD WITH FIN DIFF FOR THE PB 76 (point ', num2str(i+1), ', dimension ', num2str(n), '):  *****']);
